...
![Portuguese Brazilian language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-portuguese-brazilian-language-pack:dev-master mageplaza/module-smtp 
