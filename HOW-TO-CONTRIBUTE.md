# How to contribute Portuguese Brazilian Language pack

In this tutorial, I will show you how to contribute Portuguese Brazilian language pack
...
- [github_contributions.csv](https://github.com/mageplaza/magento-2-portuguese-brazilian-language-pack/blob/master/github_contributions.csv) has been contributed by Mageplaza and Magento community.

- We will merge `github_contributions.csv` with [pt_BR.csv](https://github.com/mageplaza/magento-2-portuguese-brazilian-language-pack/blob/master/pt_BR.csv). Your Magento 2 store will use this csv file.

So, you should contribute to [github_contributions.csv](https://github.com/mageplaza/magento-2-portuguese-brazilian-language-pack/blob/master/github_contributions.csv) file.
...
You can [install this language package via composer](https://github.com/mageplaza/magento-2-portuguese-brazilian-language-pack#-method-1-composer-method-recommend) and other people can install / contribute this language pack.
